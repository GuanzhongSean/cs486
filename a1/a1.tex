...
\begin{enumerate}[font=\Large]
	...
	\item \textbf{Backward Pass: (8 marks)}\\
	      ...
	      $$
		      \begin{aligned}
			      ...
			      %   \delta_1= & \dfrac{\partial L}{\partial \mathbf{z}^{(2)}}\dfrac{\partial \mathbf{z}^{(2)}}{\partial \mathbf{z}^{(1)}}\dfrac{\partial \mathbf{z}^{(1)}}{\partial \mathbf{a}^{(1)}}                                                                                                                                \\
			      %   =         & \dfrac{\partial L}{\partial \mathbf{z}^{(2)}}\dfrac{\partial g(\textbf{z}^{(1)}W^{(2)}) + \textbf{z}^{(1)}}{\partial \mathbf{z}^{(1)}}\dfrac{\partial \mathbf{z}^{(1)}}{\partial \mathbf{a}^{(1)}}                                                                                                   \\
			      %   =         & \dfrac{\partial L}{\partial \mathbf{z}^{(2)}}\left(g'(\mathbf{a}^{(2)})W^{(2)T}+I\right)g'(\mathbf{a}^{(1)})                                                                                                                                                                                         \\
			      %   =         & 2(\begin{bmatrix} 1.5958 & 2.1899 \end{bmatrix}-\begin{bmatrix} 1 & 0 \end{bmatrix})\left(\begin{bmatrix} 0.2493 & 0\\0& 0.2090 \end{bmatrix}\begin{bmatrix}0.7  & -0.6 \\0.5 & 0.2\end{bmatrix}-\begin{bmatrix}1  & 0 \\0 & 1\end{bmatrix}\right)\begin{bmatrix} 0.2350 &0\\0& 0.2498 \end{bmatrix} \\
			      %   =         & \begin{bmatrix} 0.4432 & 1.0977 \end{bmatrix}
		      \end{aligned}
	      $$
	      ...
	      %   $$\dfrac{\partial L}{\partial W^{(1)}}=\delta_1\otimes\mathbf{x}=\begin{bmatrix} 0.5 \\ 1 \end{bmatrix}\begin{bmatrix} 0.4432 & 1.0977 \end{bmatrix}=\begin{bmatrix} 0.2216 & 0.5489\\ 0.4432 & 1.0977 \end{bmatrix}$$
	\item \textbf{Weight Update: (5 marks)}\\
	      ...
	      % 	      0.4 & 0.1
	      %       \end{bmatrix}
	      %       -0.1\begin{bmatrix} 0.2216 & 0.5489\\ 0.4432 & 1.0977 \end{bmatrix}=\begin{bmatrix} 0.1778 & -0.3549\\ 0.3557 & 0.00997 \end{bmatrix}$$
	      $$W^{(1)}=W^{(1)}-\eta\dfrac{\partial L}{\partial W^{(1)}}=\begin{bmatrix}
			      0.2 & -0.3 \\
			      0.4 & 0.1
		      \end{bmatrix}
