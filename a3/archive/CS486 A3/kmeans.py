...
class KMeans:
    ...
    def _lloyd(self, X: np.ndarray) -> None:
        ...
        ######################################
        # FIXME: Implement Lloyd's algorithm #
        ######################################
    ...
    def _elkan(self, X: np.ndarray) -> None:
        ...
        ######################################
        # FIXME: Implement Elkan's algorithm #
        ######################################
    ...
    def _hamerly(self, X: np.ndarray) -> None:
        ...
        ########################################
        # FIXME: Implement Hamerly's algorithm #
        ########################################
    ...
    def _assign_clusters(self, X: np.ndarray, point_index: Optional[int] = None, use_bounds: bool = False, upper_bounds: Optional[np.ndarray] = None, lower_bounds: Optional[np.ndarray] = None) -> Union[np.ndarray, int]:
